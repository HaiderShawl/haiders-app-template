...
import { Menu, Moon, Sun, X, Sparkles, Zap } from "lucide-react"
...
export function Header({ user, userMembership }: HeaderProps) {
        ...
        >
          <div className="flex lg:flex-1">
            <Link href="/" className="flex items-center space-x-3">
              ...
              <span className="text-xl font-bold">Haider's App Template</span>
            </Link>
          </div>
